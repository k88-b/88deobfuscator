...
class DefineObfuscation:
    PATTERNS = {
        ...
        # marshal
		r"_\s*=\s*lambda\s*__\s*:\s*__import__\('marshal'\)\.loads\(__\[::-1\]\);\s*exec\(\(_\)" : "marshal",
        ...
        # marshal + compression
		r"_\s*=\s*lambda\s*__\s*:\s*__import__\('marshal'\)\.loads\(__import__\('zlib'\)\.decompress\(__\[::-1\]\)\);\s*exec\(\(_\)" : "marshal + zlib",
		r"_\s*=\s*lambda\s*__\s*:\s*__import__\('marshal'\)\.loads\(__import__\('gzip'\)\.decompress\(__\[::-1\]\)\);\s*exec\(\(_\)" : "marshal + gzip",
		r"_\s*=\s*lambda\s*__\s*:\s*__import__\('marshal'\)\.loads\(__import__\('lzma'\)\.decompress\(__\[::-1\]\)\);\s*exec\(\(_\)" : "marshal + lzma",
        ...
        # other
    	r"_=lambda __:__import__\('marshal'\)\.loads\(__import__\('gzip'\)\.decompress\(__import__\('lzma'\)\.decompress\(__import__\('zlib'\)\.decompress\(__import__\('base64'\)\.b64decode\(__\[::-1\]\)\)\)\)\);exec\(_\('(.*?)'\)\)" : "rendy obf (marshal , gzip , lzma , zlib, base64 )",
